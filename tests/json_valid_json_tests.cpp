...
INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(
            ...
            std::make_pair(R"("hello world")", R"("hello world")"),
            std::make_pair(R"("special character: \b ")", R"("special character: \b ")"),
            std::make_pair(R"("special character: \uAF22 ")", R"("special character: \uAF22 ")"),
            std::make_pair(R"("special character: \\ ")", R"("special character: \\ ")"),
            std::make_pair("0", "0"),
            std::make_pair("-1", "-1"),
            ...
            std::make_pair(R"({  "a":  "hello world!"})", R"({"a":"hello world!"})")
            // std::make_pair(
            //     R"([{"index":0,"guid":"bb66bf8e-ee5f-433a-9208-00db1ddec8d3","isActive":true,"balance":"$3,496.62"},{"index":1,"guid":"97e3f427-bc92-4f44-8c42-b8e708530651","isActive":false,"balance":"$1,540.04"}])",
            //     R"([{"index":0,"guid":"bb66bf8e-ee5f-433a-9208-00db1ddec8d3","isActive":true,"balance":"$3,496.62"},{"index":1,"guid":"97e3f427-bc92-4f44-8c42-b8e708530651","isActive":false,"balance":"$1,540.04"}])"
            // ),
            // std::make_pair(
            //     R"([{"a":{"a":false,"b":19.3235},"c":[19,20]},{"a":{"a":false,"b":19.4282},"c":[14,15,17,14]}])",
            //     R"([{"a":{"b":19.3235,"a":false},"c":[19,20]},{"a":{"b":19.4282,"a":false},"c":[14,15,17,14]}])"
            // )
        )
);
